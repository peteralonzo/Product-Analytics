WITH acct_credit AS -- CW Segmentation by Account Credit
(
	SELECT CONCAT('CW',BUS_UNIT_ABBR,'Account Credit',ACCT_CR_IND,'Total') as Key,
	-- Response
...
prot_class AS -- CW Segmentation by Protection Class
(
	SELECT CONCAT('CW',BUS_UNIT_ABBR,'Protection Class',(
...
ins_score_decile AS -- CW Segmentation by Ins Score Decile
(
	SELECT CONCAT('CW',BUS_UNIT_ABBR,'Insurance Score Decile',(
...
ins_age_grp AS -- CW Segmentation by Insured Age Group
(
	SELECT CONCAT('CW',BUS_UNIT_ABBR,'Insured Age Group',(
...
household_memb_cnt AS -- CW Segmentation by Household Member Count
(
	SELECT CONCAT('CW',BUS_UNIT_ABBR,'Household Member Count',(
...
aarp_member_status AS -- CW Segmentation by AARP member status
(
	SELECT CONCAT('CW',BUS_UNIT_ABBR,' AARP Member Status',(
...
(
	SELECT CONCAT('CW',BUS_UNIT_ABBR,'AARP Member Years',(
...
mortgage_count AS -- CW Segmentation by Mortgagee Count
(
	SELECT CONCAT('CW',BUS_UNIT_ABBR,'Mortgage Count',(
...
prior_cat_clm AS -- CW Segmentation by Prior CAT Claim Count
(
	SELECT CONCAT('CW',BUS_UNIT_ABBR,'Prior CAT Claim Count',(
...
prior_xcat_clm AS -- CW Segmentation by Prior xCAT Claim Count
(
	SELECT CONCAT('CW',BUS_UNIT_ABBR,'Prior xCAT Claim Count',(
...
state_deduc AS -- CW Segmentation by Deductible Amount
(
	SELECT CONCAT('CW',BUS_UNIT_ABBR,'Deductible',(
...
(
	SELECT CONCAT('CW',BUS_UNIT_ABBR,'Wind Deductible',WIND_HAIL_DED_DESC,'Total') as Key,
	-- Response
	zero_cond_scorecard(12, TO_DATE(TO_CHAR(LAST_TRANS_DT_PK_ID), 'YYYYMMDD'), RESP_IND_CNT) AS "12 Response",
	zero_cond_scorecard(11, TO_DATE(TO_CHAR(LAST_TRANS_DT_PK_ID), 'YYYYMMDD'), RESP_IND_CNT) AS "11 Response",
	zero_cond_scorecard(10, TO_DATE(TO_CHAR(LAST_TRANS_DT_PK_ID), 'YYYYMMDD'), RESP_IND_CNT) AS "10 Response",
...
pol_pkg AS -- CW Segmentation by Policy Package
(
	SELECT CONCAT('CW',BUS_UNIT_ABBR,'Policy Package',(
...
sq_foot_grp AS -- CW Segmentation by Square Foot Group
(
	SELECT CONCAT('CW',BUS_UNIT_ABBR,'Square Foot Group',(
...
(
	SELECT CONCAT('CW',BUS_UNIT_ABBR,'Cov A Per SqFt',(
...
coverage_a AS -- CW Segmentation by Coverage A
(
	SELECT CONCAT('CW',BUS_UNIT_ABBR,'Coverage A',(
...
dwelling_age AS -- CW Segmentation by Dwelling Age Group
(
	SELECT CONCAT('CW',BUS_UNIT_ABBR,'Dwelling Age Group',(
...
wind_deduc_2 AS -- CW Segmentation by Wind Deductible again?
(
	SELECT CONCAT('CW',BUS_UNIT_ABBR,'Wind Deductible',(
...
roof_age_grp AS -- CW Segmentation by Roof Age Group
(
	SELECT CONCAT('CW',BUS_UNIT_ABBR,'Roof Age Group',(
...
(
	SELECT CONCAT('CW',BUS_UNIT_ABBR,'Roof Shape',(
...
(
	SELECT CONCAT('CW',BUS_UNIT_ABBR,'Distance to Coast',(
...
fireline_score AS -- CW Segmentation by Fireline Score Code
(
	SELECT CONCAT('CW',BUS_UNIT_ABBR,'Fireline Score',(
...
(
	SELECT CONCAT('CW',BUS_UNIT_ABBR,'Dwelling Substate',(
