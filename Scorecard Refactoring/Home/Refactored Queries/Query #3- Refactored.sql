WITH prot_class AS -- State Segmentation by Protection Class
(
...
prot_class_form_cd AS -- State Segmentation by Protection Class Form Code
(
	SELECT CONCAT(RISK_ST_ABBR,'Protection Class',(
	CASE WHEN PRTCT_CLASS_CD IN ('1','2','3','4') THEN 'A. 1-4'
		 WHEN PRTCT_CLASS_CD IN ('5') THEN 'B. 5'
...
acct_credit AS -- State Segmentation by Account Credit
(
	SELECT CONCAT(RISK_ST_ABBR, 'Account Credit', ACCT_CR_IND, BU_ABBR, 'NewCo', 'Total') as Key,
	-- Response
	one_cond_scorecard(12, TRANS_DT, RESP_IND_CNT, 1, 1) AS "12 Response",
	one_cond_scorecard(11, TRANS_DT, RESP_IND_CNT, 1, 1) AS "11 Response",
	one_cond_scorecard(10, TRANS_DT, RESP_IND_CNT, 1, 1) AS "10 Response",
...
acct_credit_form_cd AS -- State Segmentation by Account Credit Form Code
(
	SELECT CONCAT(RISK_ST_ABBR, 'Account Credit', ACCT_CR_IND, BU_ABBR, 'NewCo',(
...
ins_scr_decile AS -- State Segmentation by Insurance Score Decile
(
	SELECT CONCAT(RISK_ST_ABBR,'Insurance Score Decile',(
...
ins_scr_decile_form_cd AS -- State Segmentation by Insurance Score Decile Form Code
(
	SELECT CONCAT(RISK_ST_ABBR,'Insurance Score Decile',(
	CASE WHEN INS_SCR_CD BETWEEN 830 AND 899 THEN 'Decile 01'
		 WHEN INS_SCR_CD BETWEEN 804 AND 829 THEN 'Decile 02'
...
ins_age AS -- State Segmentation by Insured Age Group
(
	SELECT CONCAT(RISK_ST_ABBR,'Insured Age Group',(
...
ins_age_form_cd AS -- State Segmentation by Insured Age Group Form Code
(
	SELECT CONCAT(RISK_ST_ABBR,'Insured Age Group',(
	CASE WHEN DATEDIFF(YEAR, ACCT_DOB, POL_EFF_DT) - 1 <= 49 THEN 'a. 25-49'
		 WHEN DATEDIFF(YEAR, ACCT_DOB, POL_EFF_DT) - 1 <= 54  THEN 'b. 50-54'
...
hh_member AS -- State Segmentation by Household Member Count
(
	SELECT CONCAT(RISK_ST_ABBR,'Household Member Count',(
...
hh_member_form_cd AS -- State Segmentation by Household Member Count Form Code
(
	SELECT CONCAT(RISK_ST_ABBR,'Household Member Count',(
	CASE WHEN HH_MEMB_CNT = 0 THEN 'other'
		 WHEN HH_MEMB_CNT = 1 THEN 'a. 1'
...
aarp_member AS -- State Segmentation by AARP Member Status
(
	SELECT CONCAT(RISK_ST_ABBR,'AARP Member',(
...
aarp_member_form_cd AS -- State Segmentation by AARP Member Status Form Code
(
	SELECT CONCAT(RISK_ST_ABBR,'AARP Member',(
	CASE WHEN AARP_MEMB_STAT_DESC = 'Tenured Member' THEN 'Tenured Member'
...
(
	SELECT CONCAT(RISK_ST_ABBR,'AARP Member Years',(
...
aarp_member_years_form_cd AS -- State Segmentation by AARP Member Years Form Code
(
	SELECT CONCAT(RISK_ST_ABBR,'AARP Member Years',(
	CASE WHEN AARP_MEMB_DAY_CNT = '0' THEN 'A. 0 Days'
		 WHEN AARP_MEMB_DAY_CNT <= 364 THEN 'B. Less than 1 year'
...
auto_afa AS -- State Segmentation by Auto AFA Count
(
	SELECT CONCAT(RISK_ST_ABBR,'Auto AFA Count',(
...
auto_afa_form_cd AS -- State Segmentation by Auto AFA Count Form Code
(
	SELECT CONCAT(RISK_ST_ABBR,'Auto AFA Count',(
	CASE WHEN HOME_RATE_PCARR_POL_AFA_CNT = 0 THEN '0'
		 WHEN HOME_RATE_PCARR_POL_AFA_CNT = 1 THEN '1'
...
auto_naf AS -- State Segmentation by Auto NAF Count
(
	SELECT CONCAT(RISK_ST_ABBR,'Auto NAF Count',(
...
auto_naf_form_cd AS -- State Segmentation by Auto NAF Count Form Code
(
	SELECT CONCAT(RISK_ST_ABBR,'Auto NAF Count',(
	CASE WHEN HOME_RATE_PCARR_POL_NAF_ACCID_CNT = 0 THEN '0'
		 WHEN HOME_RATE_PCARR_POL_NAF_ACCID_CNT = 1 THEN '1'
...
mortgage_count AS -- State Segmentation by Mortgage Count
(
	SELECT CONCAT(RISK_ST_ABBR,'Mortgage Count',(
...
mortgage_count_form_cd AS -- State Segmentation by Mortgage Count Form Code
(
	SELECT CONCAT(RISK_ST_ABBR,'Mortgage Count',(
	CASE WHEN MTGE_CNT = 0 THEN '0'
		 WHEN MTGE_CNT = 1 THEN '1'
...
prior_cat_claim AS -- State Segmentation by Prior CAT Claim Count
(
	SELECT CONCAT(RISK_ST_ABBR,'Prior CAT Claim Count',(
...
prior_cat_claim_form_cd AS -- State Segmentation by Prior CAT Claim Count Form Code
(
	SELECT CONCAT(RISK_ST_ABBR,'Prior CAT Claim Count',(
	CASE WHEN PCARR_CAT_CLM_CNT = 0 THEN 'A. None'
		 WHEN PCARR_CAT_CLM_CNT = 1 THEN 'B. 1'
...
prior_xcat_claim AS -- State Segmentation by Prior xCAT Claim Count
(
	SELECT CONCAT(RISK_ST_ABBR,'Prior xCAT Claim Count',(
...
prior_xcat_claim_form_cd AS -- State Segmentation by Prior xCAT Claim Count Form Code
(
	SELECT CONCAT(RISK_ST_ABBR,'Prior xCAT Claim Count',(
	CASE WHEN PCARR_XCAT_CLM_CNT = 0 THEN 'A. None'
		 WHEN PCARR_XCAT_CLM_CNT = 1 THEN 'B. 1'
...
deduc AS -- State Segmentation by Deductible
(
	SELECT CONCAT(RISK_ST_ABBR,'Deductible',(
...
deduc_form_cd AS -- State Segmentation by Deductible Form Code
(
	SELECT CONCAT(RISK_ST_ABBR,'Deductible',(
	CASE WHEN COV_DEDUC_AMT_TYP_DESC = 'FLAT' AND COV_FLAT_DEDUC_AMT IN ('500','750') THEN 'a. Less than 1000'
		 WHEN COV_DEDUC_AMT_TYP_DESC = 'FLAT' AND COV_FLAT_DEDUC_AMT IN ('1000','1500') THEN 'b. 1000-1500'
...
(
	SELECT CONCAT(RISK_ST_ABBR,'Wind Deductible',(
...
opt_cov_pkg AS -- State Segmentation by Optional Coverage Package
(
	SELECT CONCAT(RISK_ST_ABBR,'Optional Coverage Package',(
...
opt_cov_pkg_form_cd AS -- State Segmentation by Optional Coverage Package Form Code
(
	SELECT CONCAT(RISK_ST_ABBR,'Optional Coverage Package',(
	CASE WHEN OPT_COV_PKG_CD = 'P1B001' THEN 'P1'
		 WHEN OPT_COV_PKG_CD = 'P2B001' THEN 'P2'
...
cov_a AS -- State Segmentation by Coverage A
(
	SELECT CONCAT(RISK_ST_ABBR,'Coverage A',(
...
sq_ft AS -- State Segmentation by Square Foot Group
(
	SELECT CONCAT(RISK_ST_ABBR,'Square Foot Group',(
...
(
	SELECT CONCAT(RISK_ST_ABBR,'Cov A Per SqFt',(
...
dwell_age AS -- State Segmentation by Dwelling Age Group
(
	SELECT CONCAT(RISK_ST_ABBR,'Dwelling Age Group',(
...
roof_age AS -- State Segmentation by Roof Age
(
	SELECT CONCAT(RISK_ST_ABBR,'Roof Age Group',(
...
roof_sqft AS -- State Segmentation by Roof SqFt Size
(
	SELECT CONCAT(RISK_ST_ABBR,'Roof SqFt Size',(
...
hail_roof AS -- State Segmentation by Hail Roof Symbol Code
(
	SELECT CONCAT(RISK_ST_ABBR,'Hail Roof Symbol Group',(
...
roof_cond AS -- State Segmentation by Roof Condition Score
(
	SELECT CONCAT(RISK_ST_ABBR, 'Roof Condition Score', roof_cond_deriv_scr_num, BU_ABBR, 'NewCo', 'Total') as Key,
	-- Response
	one_cond_scorecard(12, TRANS_DT, RESP_IND_CNT, 1, 1) AS "12 Response",
	one_cond_scorecard(11, TRANS_DT, RESP_IND_CNT, 1, 1) AS "11 Response",
	one_cond_scorecard(10, TRANS_DT, RESP_IND_CNT, 1, 1) AS "10 Response",
...
(
	SELECT CONCAT(RISK_ST_ABBR,'Roof Shape',( 
...
build_fax_conf AS -- State Segmentation by Build Fax Roof Age Confidence
(
	SELECT CONCAT(RISK_ST_ABBR,'Build Fax Roof Age Confidence',( 
...
tree_overhang AS -- State Segmentation by Tree Overhang
(
	SELECT CONCAT(RISK_ST_ABBR,'Tree Overhang',( 
...
cape_cov AS -- State Segmentation by Cape Coverage
(
	SELECT CONCAT(RISK_ST_ABBR,'Cape Coverage',(
...
const_mat AS -- State Segmentation by Construction Material
(
	SELECT CONCAT(RISK_ST_ABBR,'Construction Material',(
...
story_cnt AS -- State Segmentation by Story Count
(
	SELECT CONCAT(RISK_ST_ABBR,'Story Count',(
...
fire_alarm AS -- State Segmentation by Fire Alarm
(
	SELECT CONCAT(RISK_ST_ABBR,'Fire Alarm',(
...
fire_alarm_form_cd AS -- State Segmentation by Fire Alarm Form Code
(
	SELECT CONCAT(RISK_ST_ABBR,'Fire Alarm',(
	CASE WHEN FIRE_ALARM_DESC = 'Monitored' THEN 'a. Monitored'
		 WHEN FIRE_ALARM_DESC = 'NonMonitored' THEN 'b. Non-Monitored'
...
(
	SELECT CONCAT(RISK_ST_ABBR,'Distance to Coast',(
...
fireline_score AS -- State Segmentation by Fireline Score
(
	SELECT CONCAT(RISK_ST_ABBR,'Fireline Score',(
...
hazard_hub AS -- State Segmentation by Hazard Hub Score
(
	SELECT CONCAT(RISK_ST_ABBR,'HazardHub',(
...
limited_access AS -- State Segmentation by Limited Access
(
	SELECT CONCAT(RISK_ST_ABBR, 'Limited Access', LTD_ACCSS_CR_IND, BU_ABBR, 'NewCo', 'Total') as Key,
	-- Response
	one_cond_scorecard(12, TRANS_DT, RESP_IND_CNT, 1, 1) AS "12 Response",
	one_cond_scorecard(11, TRANS_DT, RESP_IND_CNT, 1, 1) AS "11 Response",
	one_cond_scorecard(10, TRANS_DT, RESP_IND_CNT, 1, 1) AS "10 Response",
...
(
	SELECT CONCAT(RISK_ST_ABBR,'Dwelling Substate',(
...
dwell_substate_form_cd AS -- State Segmentation by Dwelling Substate Form Code
(
	SELECT CONCAT(RISK_ST_ABBR,'Dwelling Substate',(
	CASE WHEN RISK_ST_ABBR = 'IA' AND GARAGE_SUBSTATE IN ('Cedar Rapids/Iowa City metro', 'Central Iowa', 'Des Moines/Ames Metro', 'East Iowa', 'West Iowa/KS border') THEN GARAGE_SUBSTATE
		 WHEN RISK_ST_ABBR <> 'IA' AND LEFT(RISK_ST_ABBR, 2) = LEFT(GARAGE_SUBSTATE,2) THEN GARAGE_SUBSTATE
